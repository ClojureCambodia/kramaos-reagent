...
var G__37599 = o;
(G__37599[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__37601__i < G__37601__a.length) {G__37601__a[G__37601__i] = arguments[G__37601__i + 0]; ++G__37601__i;}
  args = new cljs.core.IndexedSeq(G__37601__a,0,null);
} 
...
var args = cljs.core.seq(arglist__37602);
...
var G__37603 = o;
(G__37603[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__37608 = props;
var G__37608__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__37608,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37608);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__37608__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__37609){
...
var props = map__37610__$1;
var class$ = cljs.core.get.call(null,map__37610__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__37610,map__37610__$1,props,class$){
return (function (c){
...
});})(map__37610,map__37610__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__37612){
...
var on_write = cljs.core.get.call(null,map__37613__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__37613,map__37613__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__37613,map__37613__$1,on_write))
);
} else {
...
var G__37616 = jsprops;
(G__37616["defaultValue"] = value);

(G__37616["onChange"] = ((function (G__37616,v,value,on_change){
return (function (p1__37615_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__37615_SHARP_);
});})(G__37616,v,value,on_change))
);
...
var vec__37619 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__37619,(0),null);
var id = cljs.core.nth.call(null,vec__37619,(1),null);
var class$ = cljs.core.nth.call(null,vec__37619,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___37623 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___37623 == null)){
} else {
var key_37624 = temp__5461__auto___37623;
...
var temp__5461__auto___37625 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___37625 == null)){
} else {
var key_37626 = temp__5461__auto___37625;
reagent.impl.template.oset.call(null,jsprops,"key",key_37626);
}
...
var G__37627 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__37627["name"] = c);
...
var len__4641__auto___37632 = arguments.length;
var i__4642__auto___37633 = (0);
while(true){
if((i__4642__auto___37633 < len__4641__auto___37632)){
args__4647__auto__.push((arguments[i__4642__auto___37633]));

var G__37634 = (i__4642__auto___37633 + (1));
i__4642__auto___37633 = G__37634;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq37630){
var G__37631 = cljs.core.first.call(null,seq37630);
var seq37630__$1 = cljs.core.next.call(null,seq37630);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37631,seq37630__$1);
});
...
break;
default:
var G__37637 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__37637;
continue;
...
var n__4518__auto___37639 = a.length;
var i_37640 = (0);
while(true){
if((i_37640 < n__4518__auto___37639)){
(a[i_37640] = reagent.impl.template.as_element.call(null,(a[i_37640])));

var G__37641 = (i_37640 + (1));
i_37640 = G__37641;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4518__auto___37642 = a.length;
var i_37643 = (0);
while(true){
if((i_37643 < n__4518__auto___37642)){
var val_37644 = (a[i_37643]);
if(((cljs.core.vector_QMARK_.call(null,val_37644)) && ((reagent.impl.template.key_from_vec.call(null,val_37644) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_37643] = reagent.impl.template.as_element.call(null,val_37644));

var G__37645 = (i_37643 + (1));
i_37643 = G__37645;
continue;
} else {
}
...
var ctx = ({});
var vec__37646 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__37646,(0),null);
var derefed = cljs.core.nth.call(null,vec__37646,(1),null);
...
var G__37649 = (cljs.core.count.call(null,argv) - first_child);
switch (G__37649) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__37649){
...
//# sourceMappingURL=template.js.map?rel=1545903842928
