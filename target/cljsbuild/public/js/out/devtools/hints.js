...
var file = cljs.core.get.call(null,map__39178__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__39178__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__39178__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e39177){var _e = e39177;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___39180 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___39180)){
var seen_errors_39181 = temp__5455__auto___39180;
if(cljs.core.truth_(seen_errors_39181.has(self))){
} else {
seen_errors_39181.add(self);

var temp__5457__auto___39182 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___39182)){
var sense_39183 = temp__5457__auto___39182;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_39183)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1545903847192
