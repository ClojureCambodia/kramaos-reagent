...
var temp__5455__auto___32037 = event.state;
if(cljs.core.truth_(temp__5455__auto___32037)){
var state_32038 = temp__5455__auto___32037;
var temp__5457__auto___32039 = (state_32038["scroll-top"]);
if(cljs.core.truth_(temp__5457__auto___32039)){
var scroll_top_32040 = temp__5457__auto___32039;
goog.events.listenOnce(window,goog.events.EventType.SCROLL,((function (scroll_top_32040,temp__5457__auto___32039,state_32038,temp__5455__auto___32037){
return (function (){
scrollTo((0),scroll_top_32040);

return null;
});})(scroll_top_32040,temp__5457__auto___32039,state_32038,temp__5455__auto___32037))
);
} else {
}
} else {
...
var scroll_top_32041 = clerk.core.get_scroll_top.call(null);
var state_32042 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"scroll-top","scroll-top",-46723100),scroll_top_32041], null);
history.replaceState(cljs.core.clj__GT_js.call(null,state_32042),document.title);
...
var len__4641__auto___32049 = arguments.length;
var i__4642__auto___32050 = (0);
while(true){
if((i__4642__auto___32050 < len__4641__auto___32049)){
args__4647__auto__.push((arguments[i__4642__auto___32050]));

var G__32051 = (i__4642__auto___32050 + (1));
i__4642__auto___32050 = G__32051;
continue;
} else {
}
break;
...
clerk.core.navigate_page_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__32045){
var vec__32046 = p__32045;
var top_element_id = cljs.core.nth.call(null,vec__32046,(0),null);
...
return clerk.core.defer_page_navigation_BANG_.call(null,((function (y,temp__5455__auto__,uri,path,old_path,same_page_QMARK_,fragment,vec__32046,top_element_id){
return (function (){
return clerk.core.scroll_to.call(null,y);
});})(y,temp__5455__auto__,uri,path,old_path,same_page_QMARK_,fragment,vec__32046,top_element_id))
);
}
} else {
...
return clerk.core.defer_page_navigation_BANG_.call(null,((function (y_translation,temp__5455__auto__,uri,path,old_path,same_page_QMARK_,fragment,vec__32046,top_element_id){
return (function (){
...
});})(y_translation,temp__5455__auto__,uri,path,old_path,same_page_QMARK_,fragment,vec__32046,top_element_id))
);
}
}
});
...
/** @this {Function} */
clerk.core.navigate_page_BANG_.cljs$lang$applyTo = (function (seq32043){
var G__32044 = cljs.core.first.call(null,seq32043);
var seq32043__$1 = cljs.core.next.call(null,seq32043);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32044,seq32043__$1);
});
...
//# sourceMappingURL=core.js.map?rel=1545897035622
