...
var temp__5455__auto___27972 = event.state;
if(cljs.core.truth_(temp__5455__auto___27972)){
var state_27973 = temp__5455__auto___27972;
var temp__5457__auto___27974 = (state_27973["scroll-top"]);
if(cljs.core.truth_(temp__5457__auto___27974)){
var scroll_top_27975 = temp__5457__auto___27974;
goog.events.listenOnce(window,goog.events.EventType.SCROLL,((function (scroll_top_27975,temp__5457__auto___27974,state_27973,temp__5455__auto___27972){
return (function (){
scrollTo((0),scroll_top_27975);

return null;
});})(scroll_top_27975,temp__5457__auto___27974,state_27973,temp__5455__auto___27972))
);
} else {
}
} else {
...
var scroll_top_27976 = clerk.core.get_scroll_top.call(null);
var state_27977 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"scroll-top","scroll-top",-46723100),scroll_top_27976], null);
history.replaceState(cljs.core.clj__GT_js.call(null,state_27977),document.title);
...
var len__4641__auto___27984 = arguments.length;
var i__4642__auto___27985 = (0);
while(true){
if((i__4642__auto___27985 < len__4641__auto___27984)){
args__4647__auto__.push((arguments[i__4642__auto___27985]));

var G__27986 = (i__4642__auto___27985 + (1));
i__4642__auto___27985 = G__27986;
continue;
} else {
}
break;
...
clerk.core.navigate_page_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__27980){
var vec__27981 = p__27980;
var top_element_id = cljs.core.nth.call(null,vec__27981,(0),null);
...
return clerk.core.defer_page_navigation_BANG_.call(null,((function (y,temp__5455__auto__,uri,path,old_path,same_page_QMARK_,fragment,vec__27981,top_element_id){
return (function (){
return clerk.core.scroll_to.call(null,y);
});})(y,temp__5455__auto__,uri,path,old_path,same_page_QMARK_,fragment,vec__27981,top_element_id))
);
}
} else {
...
return clerk.core.defer_page_navigation_BANG_.call(null,((function (y_translation,temp__5455__auto__,uri,path,old_path,same_page_QMARK_,fragment,vec__27981,top_element_id){
return (function (){
...
});})(y_translation,temp__5455__auto__,uri,path,old_path,same_page_QMARK_,fragment,vec__27981,top_element_id))
);
}
}
});
...
/** @this {Function} */
clerk.core.navigate_page_BANG_.cljs$lang$applyTo = (function (seq27978){
var G__27979 = cljs.core.first.call(null,seq27978);
var seq27978__$1 = cljs.core.next.call(null,seq27978);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27979,seq27978__$1);
});
...
//# sourceMappingURL=core.js.map?rel=1545901503130
