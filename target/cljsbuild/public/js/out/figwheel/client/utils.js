...
return (new CustomEvent(event_name,(function (){var obj28977 = {"detail":data};
return obj28977;
})()));
} else {
...
var f = (function (){var pred__28984 = cljs.core._EQ_;
var expr__28985 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28984.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28985))){
return ((function (pred__28984,expr__28985){
return (function (p1__28978_SHARP_){
return console.warn(p1__28978_SHARP_);
});
;})(pred__28984,expr__28985))
} else {
if(cljs.core.truth_(pred__28984.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28985))){
return ((function (pred__28984,expr__28985){
return (function (p1__28979_SHARP_){
return console.debug(p1__28979_SHARP_);
});
;})(pred__28984,expr__28985))
} else {
if(cljs.core.truth_(pred__28984.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28985))){
return ((function (pred__28984,expr__28985){
return (function (p1__28980_SHARP_){
return console.error(p1__28980_SHARP_);
});
;})(pred__28984,expr__28985))
} else {
return ((function (pred__28984,expr__28985){
return (function (p1__28981_SHARP_){
return console.log(p1__28981_SHARP_);
});
;})(pred__28984,expr__28985))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__28988){
...
var opts = map__28989__$1;
var eval_fn = cljs.core.get.call(null,map__28989__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__28991_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__28993,(0),null);
...
}catch (e28998){if((e28998 instanceof Error)){
var e = e28998;
return not_found;
} else {
throw e28998;
...
//# sourceMappingURL=utils.js.map?rel=1545901505168
