...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__39629 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__39629,ch);
...
if(("\\" === ch__$1)){
var ch_39630__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_39630__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_39630__$2);
} else {
}

var G__39631 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__39631;
continue;
}
}
...
var vec__39639 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__39639,(0),null);
var start_column = cljs.core.nth.call(null,vec__39639,(1),null);
...
var G__39642 = cljs.core.conj_BANG_.call(null,a,form);
a = G__39642;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__39643 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__39644 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__39644;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__39643;
}});
/**
...
var vec__39651 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__39651,(0),null);
var start_column = cljs.core.nth.call(null,vec__39651,(1),null);
...
var vec__39654 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__39654,(0),null);
var end_column = cljs.core.nth.call(null,vec__39654,(1),null);
...
var vec__39657 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__39657,(0),null);
var start_column = cljs.core.nth.call(null,vec__39657,(1),null);
...
var vec__39660 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__39660,(0),null);
var end_column = cljs.core.nth.call(null,vec__39660,(1),null);
...
var sb = (function (){var G__39663 = (new goog.string.StringBuffer());
G__39663.append(initch);
...
var G__39665 = (function (){var G__39664 = sb;
G__39664.append(ch);

return G__39664;
})();
var G__39666 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__39665;
ch = G__39666;
continue;
}
...
switch (G__39669) {
case "\\":
var G__39673 = (function (){var G__39670 = sb;
G__39670.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__39670;
})();
var G__39674 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__39673;
ch = G__39674;
continue;
...
break;
default:
var G__39675 = (function (){var G__39671 = sb;
G__39671.append(ch);

return G__39671;
})();
var G__39676 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__39675;
ch = G__39676;
continue;
...
var vec__39677 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__39677,(0),null);
var end_column = cljs.core.nth.call(null,vec__39677,(1),null);
...
var vec__39680 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__39680,(0),null);
var column = cljs.core.nth.call(null,vec__39680,(1),null);
...
var vec__39685 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__39685,(0),null);
var column = cljs.core.nth.call(null,vec__39685,(1),null);
...
var line = cljs.core.nth.call(null,vec__39690,(0),null);
var column = cljs.core.nth.call(null,vec__39690,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__39695 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__39695,(0),null);
var start_column = cljs.core.nth.call(null,vec__39695,(1),null);
...
var vec__39698 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__39698,(0),null);
var end_column = cljs.core.nth.call(null,vec__39698,(1),null);
...
var G__39701 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__39701,true,null,opts,pending_forms);
...
var G__39702 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__39702)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__39702)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__39702)){
...
var _STAR_suppress_read_STAR__orig_val__39703 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__39704 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__39704;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__39703;
}});
...
var G__39705 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__39705,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__39705,rdr,first_line);
...
var G__39709 = matched;
var G__39710 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__39709;
finished = G__39710;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__39711 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__39712 = (function (){var or__4047__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__39712;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__39711;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__39713 = cljs.tools.reader.arg_env;
var arg_env_temp_val__39714 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__39714;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__39715 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__39715,"(");
...
var G__39716 = (i + (1));
var G__39717 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4047__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__39713;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__39718 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__39718);
...
var G__39719 = cljs.core.next.call(null,s__$1);
var G__39720 = ret;
s__$1 = G__39719;
r = G__39720;
continue;
...
var G__39721 = cljs.core.next.call(null,s);
var G__39722 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__39721;
key_vals = G__39722;
continue;
} else {
...
var gensym_env_orig_val__39726 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__39727 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__39727;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__39726;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__39728 = token;
var G__39728__$1 = (((G__39728 == null))?null:cljs.core.subs.call(null,G__39728,(1)));
var G__39728__$2 = (((G__39728__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__39728__$1));
var G__39728__$3 = (((G__39728__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__39728__$2));
var G__39728__$4 = (((G__39728__$3 == null))?null:cljs.core.symbol.call(null,G__39728__$3));
if((G__39728__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__39728__$4);
}
})():(function (){var G__39729 = token;
var G__39729__$1 = (((G__39729 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__39729));
if((G__39729__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__39729__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__39740,reader){
...
var eof = cljs.core.get.call(null,map__39741__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4641__auto___39749 = arguments.length;
var i__4642__auto___39750 = (0);
while(true){
if((i__4642__auto___39750 < len__4641__auto___39749)){
args__4647__auto__.push((arguments[i__4642__auto___39750]));

var G__39751 = (i__4642__auto___39750 + (1));
i__4642__auto___39750 = G__39751;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq39747){
var G__39748 = cljs.core.first.call(null,seq39747);
var seq39747__$1 = cljs.core.next.call(null,seq39747);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39748,seq39747__$1);
});


//# sourceMappingURL=reader.js.map?rel=1545903849947
