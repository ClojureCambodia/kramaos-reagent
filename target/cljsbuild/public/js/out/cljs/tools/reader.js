...
var G__41922 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__41922;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__41923 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__41923,ch);
...
if(("\\" === ch__$1)){
var ch_41924__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_41924__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_41924__$2);
} else {
}

var G__41925 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__41925;
continue;
}
}
...
var start_line = cljs.core.nth.call(null,vec__41933,(0),null);
var start_column = cljs.core.nth.call(null,vec__41933,(1),null);
...
var G__41936 = cljs.core.conj_BANG_.call(null,a,form);
a = G__41936;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__41937 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__41938 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__41938;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__41937;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__41939 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41939,(0),null);
var start_column = cljs.core.nth.call(null,vec__41939,(1),null);
...
var vec__41942 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41942,(0),null);
var end_column = cljs.core.nth.call(null,vec__41942,(1),null);
...
var vec__41945 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41945,(0),null);
var start_column = cljs.core.nth.call(null,vec__41945,(1),null);
...
var vec__41948 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41948,(0),null);
var end_column = cljs.core.nth.call(null,vec__41948,(1),null);
...
var vec__41951 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41951,(0),null);
var start_column = cljs.core.nth.call(null,vec__41951,(1),null);
...
var vec__41954 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41954,(0),null);
var end_column = cljs.core.nth.call(null,vec__41954,(1),null);
...
var sb = (function (){var G__41957 = (new goog.string.StringBuffer());
G__41957.append(initch);
...
var G__41959 = (function (){var G__41958 = sb;
G__41958.append(ch);

return G__41958;
})();
var G__41960 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__41959;
ch = G__41960;
continue;
}
...
switch (G__41963) {
case "\\":
var G__41967 = (function (){var G__41964 = sb;
G__41964.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__41964;
})();
var G__41968 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__41967;
ch = G__41968;
continue;
...
break;
default:
var G__41969 = (function (){var G__41965 = sb;
G__41965.append(ch);

return G__41965;
})();
var G__41970 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__41969;
ch = G__41970;
continue;
...
var vec__41971 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41971,(0),null);
var end_column = cljs.core.nth.call(null,vec__41971,(1),null);
...
var vec__41974 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__41974,(0),null);
var column = cljs.core.nth.call(null,vec__41974,(1),null);
...
var vec__41979 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__41979,(0),null);
var column = cljs.core.nth.call(null,vec__41979,(1),null);
...
var vec__41984 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__41984,(0),null);
var column = cljs.core.nth.call(null,vec__41984,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__41989 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41989,(0),null);
var start_column = cljs.core.nth.call(null,vec__41989,(1),null);
...
var vec__41992 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41992,(0),null);
var end_column = cljs.core.nth.call(null,vec__41992,(1),null);
...
var G__41995 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__41995,true,null,opts,pending_forms);
...
var G__41996 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__41996)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__41996)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__41996)){
...
var _STAR_suppress_read_STAR__orig_val__41997 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__41998 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__41998;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__41997;
}});
...
var G__41999 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__41999,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__41999,rdr,first_line);
...
var G__42003 = matched;
var G__42004 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__42003;
finished = G__42004;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__42005 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__42006 = (function (){var or__4047__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__42006;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__42005;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__42007 = cljs.tools.reader.arg_env;
var arg_env_temp_val__42008 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__42008;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__42009 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__42009,"(");
...
var G__42010 = (i + (1));
var G__42011 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4047__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__42007;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__42012 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__42012);
...
var G__42013 = cljs.core.next.call(null,s__$1);
var G__42014 = ret;
s__$1 = G__42013;
r = G__42014;
continue;
...
var G__42015 = cljs.core.next.call(null,s);
var G__42016 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__42015;
key_vals = G__42016;
continue;
} else {
...
var gensym_env_orig_val__42020 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__42021 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__42021;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__42020;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__42022 = token;
var G__42022__$1 = (((G__42022 == null))?null:cljs.core.subs.call(null,G__42022,(1)));
var G__42022__$2 = (((G__42022__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__42022__$1));
var G__42022__$3 = (((G__42022__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__42022__$2));
var G__42022__$4 = (((G__42022__$3 == null))?null:cljs.core.symbol.call(null,G__42022__$3));
if((G__42022__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__42022__$4);
}
})():(function (){var G__42023 = token;
var G__42023__$1 = (((G__42023 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__42023));
if((G__42023__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__42023__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__42034,reader){
...
var eof = cljs.core.get.call(null,map__42035__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4641__auto___42043 = arguments.length;
var i__4642__auto___42044 = (0);
while(true){
if((i__4642__auto___42044 < len__4641__auto___42043)){
args__4647__auto__.push((arguments[i__4642__auto___42044]));

var G__42045 = (i__4642__auto___42044 + (1));
i__4642__auto___42044 = G__42045;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq42041){
var G__42042 = cljs.core.first.call(null,seq42041);
var seq42041__$1 = cljs.core.next.call(null,seq42041);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42042,seq42041__$1);
});


//# sourceMappingURL=reader.js.map?rel=1545897056342
