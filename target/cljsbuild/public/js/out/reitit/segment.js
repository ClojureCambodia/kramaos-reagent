...
reitit.segment.Match.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4303__auto__,k38005,else__4304__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k38005,else__4304__auto__);
...
return (function (ret__4323__auto__,p__38010){
var vec__38011 = p__38010;
var k__4324__auto__ = cljs.core.nth.call(null,vec__38011,(0),null);
var v__4325__auto__ = cljs.core.nth.call(null,vec__38011,(1),null);
...
reitit.segment.Match.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__38004){
var self__ = this;
var G__38004__$1 = this;
return (new cljs.core.RecordIter((0),G__38004__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data","data",-232669377),new cljs.core.Keyword(null,"path-params","path-params",-48130597)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
reitit.segment.Match.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this38006,other38007){
var self__ = this;
var this38006__$1 = this;
return (((!((other38007 == null)))) && ((this38006__$1.constructor === other38007.constructor)) && (cljs.core._EQ_.call(null,this38006__$1.data,other38007.data)) && (cljs.core._EQ_.call(null,this38006__$1.path_params,other38007.path_params)) && (cljs.core._EQ_.call(null,this38006__$1.__extmap,other38007.__extmap)));
});
...
reitit.segment.Match.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4308__auto__,k__4309__auto__,G__38004){
var self__ = this;
var this__4308__auto____$1 = this;
var pred__38014 = cljs.core.keyword_identical_QMARK_;
var expr__38015 = k__4309__auto__;
if(cljs.core.truth_(pred__38014.call(null,new cljs.core.Keyword(null,"data","data",-232669377),expr__38015))){
return (new reitit.segment.Match(G__38004,self__.path_params,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__38014.call(null,new cljs.core.Keyword(null,"path-params","path-params",-48130597),expr__38015))){
return (new reitit.segment.Match(self__.data,G__38004,self__.__meta,self__.__extmap,null));
} else {
return (new reitit.segment.Match(self__.data,self__.path_params,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4309__auto__,G__38004),null));
}
}
});
...
reitit.segment.Match.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4300__auto__,G__38004){
var self__ = this;
var this__4300__auto____$1 = this;
return (new reitit.segment.Match(self__.data,self__.path_params,G__38004,self__.__extmap,self__.__hash));
});
 ...
 */
reitit.segment.map__GT_Match = (function reitit$segment$map__GT_Match(G__38008){
var extmap__4340__auto__ = (function (){var G__38017 = cljs.core.dissoc.call(null,G__38008,new cljs.core.Keyword(null,"data","data",-232669377),new cljs.core.Keyword(null,"path-params","path-params",-48130597));
if(cljs.core.record_QMARK_.call(null,G__38008)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__38017);
} else {
return G__38017;
}
})();
return (new reitit.segment.Match(new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(G__38008),new cljs.core.Keyword(null,"path-params","path-params",-48130597).cljs$core$IFn$_invoke$arity$1(G__38008),null,cljs.core.not_empty.call(null,extmap__4340__auto__),null));
});
...
if((typeof reitit !== 'undefined') && (typeof reitit.segment !== 'undefined') && (typeof reitit.segment.t_reitit$segment38023 !== 'undefined')){
} else {
 ...
 * @implements {cljs.core.IWithMeta}
*/
reitit.segment.t_reitit$segment38023 = (function (children,wilds,catch_all,match,children_SINGLEQUOTE_,wilds_QMARK_,meta38024){
...
reitit.segment.t_reitit$segment38023.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (children_SINGLEQUOTE_,wilds_QMARK_){
return (function (_38025,meta38024__$1){
var self__ = this;
var _38025__$1 = this;
return (new reitit.segment.t_reitit$segment38023(self__.children,self__.wilds,self__.catch_all,self__.match,self__.children_SINGLEQUOTE_,self__.wilds_QMARK_,meta38024__$1));
});})(children_SINGLEQUOTE_,wilds_QMARK_))
;

reitit.segment.t_reitit$segment38023.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (children_SINGLEQUOTE_,wilds_QMARK_){
...
reitit.segment.t_reitit$segment38023.prototype.reitit$segment$Segment$ = cljs.core.PROTOCOL_SENTINEL;

reitit.segment.t_reitit$segment38023.prototype.reitit$segment$Segment$_insert$arity$3 = ((function (children_SINGLEQUOTE_,wilds_QMARK_){
return (function (_,p__38026,d){
var self__ = this;
...
var p = first__38029;
var ps = seq__38028__$1;
var ___$1 = this;
if(cljs.core.not.call(null,p)){
return reitit.segment.segment.call(null,self__.children,self__.wilds,self__.catch_all,d);
} else {
var vec__38030 = cljs.core.juxt.call(null,reitit.impl.wild_param,reitit.impl.catch_all_param).call(null,p);
var w = cljs.core.nth.call(null,vec__38030,(0),null);
var c = cljs.core.nth.call(null,vec__38030,(1),null);
...
})(),((function (vec__38030,w,c,wilds__$1,catch_all__$1,___$1,vec__38027,seq__38028,first__38029,seq__38028__$1,p,ps,children_SINGLEQUOTE_,wilds_QMARK_){
return (function (p1__38019_SHARP_){
return reitit.segment._insert.call(null,(function (){var or__4047__auto__ = p1__38019_SHARP_;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
});})(vec__38030,w,c,wilds__$1,catch_all__$1,___$1,vec__38027,seq__38028,first__38029,seq__38028__$1,p,ps,children_SINGLEQUOTE_,wilds_QMARK_))
);
...
reitit.segment.t_reitit$segment38023.prototype.reitit$segment$Segment$_lookup$arity$3 = ((function (children_SINGLEQUOTE_,wilds_QMARK_){
return (function (_,p__38033,path_params){
var self__ = this;
...
var or__4047__auto____$1 = (cljs.core.truth_(self__.wilds_QMARK_)?cljs.core.some.call(null,((function (or__4047__auto__,___$1,vec__38034,seq__38035,first__38036,seq__38035__$1,p,ps,children_SINGLEQUOTE_,wilds_QMARK_){
return (function (p1__38020_SHARP_){
return reitit.segment._lookup.call(null,reitit.impl.fast_get.call(null,self__.children_SINGLEQUOTE_,p1__38020_SHARP_),ps,cljs.core.assoc.call(null,path_params,p1__38020_SHARP_,p));
});})(or__4047__auto__,___$1,vec__38034,seq__38035,first__38036,seq__38035__$1,p,ps,children_SINGLEQUOTE_,wilds_QMARK_))
,self__.wilds):null);
if(cljs.core.truth_(or__4047__auto____$1)){
return or__4047__auto____$1;
} else {
...
reitit.segment.t_reitit$segment38023.getBasis = ((function (children_SINGLEQUOTE_,wilds_QMARK_){
return (function (){
return new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"children","children",699969545,null),new cljs.core.Symbol(null,"wilds","wilds",1772802750,null),new cljs.core.Symbol(null,"catch-all","catch-all",-1470323199,null),new cljs.core.Symbol(null,"match","match",-1434376219,null),new cljs.core.Symbol(null,"children'","children'",-942868266,null),new cljs.core.Symbol(null,"wilds?","wilds?",-1842060252,null),new cljs.core.Symbol(null,"meta38024","meta38024",-1566353176,null)], null);
});})(children_SINGLEQUOTE_,wilds_QMARK_))
;

reitit.segment.t_reitit$segment38023.cljs$lang$type = true;

reitit.segment.t_reitit$segment38023.cljs$lang$ctorStr = "reitit.segment/t_reitit$segment38023";

reitit.segment.t_reitit$segment38023.cljs$lang$ctorPrWriter = ((function (children_SINGLEQUOTE_,wilds_QMARK_){
return (function (this__4290__auto__,writer__4291__auto__,opt__4292__auto__){
return cljs.core._write.call(null,writer__4291__auto__,"reitit.segment/t_reitit$segment38023");
});})(children_SINGLEQUOTE_,wilds_QMARK_))
;

/**
 * Positional factory function for reitit.segment/t_reitit$segment38023.
 */
reitit.segment.__GT_t_reitit$segment38023 = ((function (children_SINGLEQUOTE_,wilds_QMARK_){
return (function reitit$segment$__GT_t_reitit$segment38023(children__$1,wilds__$1,catch_all__$1,match__$1,children_SINGLEQUOTE___$1,wilds_QMARK___$1,meta38024){
return (new reitit.segment.t_reitit$segment38023(children__$1,wilds__$1,catch_all__$1,match__$1,children_SINGLEQUOTE___$1,wilds_QMARK___$1,meta38024));
});})(children_SINGLEQUOTE_,wilds_QMARK_))
;

}

return (new reitit.segment.t_reitit$segment38023(children,wilds,catch_all,match,children_SINGLEQUOTE_,wilds_QMARK_,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("reitit.segment","segment","reitit.segment/segment",424393474)], null)));
});
...
return cljs.core.reduce.call(null,(function (segment,p__38038){
var vec__38039 = p__38038;
var p = cljs.core.nth.call(null,vec__38039,(0),null);
var data = cljs.core.nth.call(null,vec__38039,(1),null);
...
//# sourceMappingURL=segment.js.map?rel=1545903843862
